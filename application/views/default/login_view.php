            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?=lang('login_title');?></h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="<?=base_url();?>cms/login" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="<?=lang('username_or_e_mail');?>" name="username" type="text" autofocus required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="<?=lang('password');?>" name="password" type="password" value="" required>
                                </div>
                                <div class="checkbox">
                                    <label>
                                ...
                                <input type="submit" class="btn btn-lg btn-success btn-block" value="<?=lang('login');?>" \>
                            </fieldset>
                        </form>
                    </div>
                </div>
