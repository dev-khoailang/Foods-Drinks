...
class ControllerList
{
    ...
    /** @var array that will ignore the controller names and method */
    ...
    {
        $p_sControllerName = strtolower($p_sControllerName);

        if (!in_array($p_sControllerName, $this->ignores)) {
    ...
    private function setControllers()
    {
        ...
        foreach (glob(APPPATH . 'controllers/cms/*') as $controller) {
